...
<body class="inicial">
    ...
    <header class="top-container">
        ...
        <nav class="nav-right">
            <ul class="top-list">
                ...
                <span>
                    <li><button id="btnlogin"><a href="login.php">LOGIN</a></button></li>
                </span>
            </ul>
        </nav>
    </header>
    ...
    <main class="mid-container">
        <div class="column">
            <h1><span id="destaque">FITNESS</span> MANAGER</h1>
            <p>O melhor site para gerenciamento sua academia. LETS BORA?</p>
            <a href="login.php"><button id="btnacessar">Acessar</button></a>
        </div>
    </main>
    <!--FIM DO MAIN-->
