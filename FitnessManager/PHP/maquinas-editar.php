...
$consulta3 = $conexao->query("select * from tb_maquinas order by maq_nome");
...
<body>
        ...
        <nav class="nav-right">
            <ul class="top-list">
                <span id="back">
                    <li><a href="maquinas.php"><i class="fas fa-arrow-alt-circle-left"
                    style="font-size: 42px; color: #fea303;"></i></i></a></li>
                </span>
            </ul>
        </nav>
    </header>
