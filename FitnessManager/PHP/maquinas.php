...
<body>
    ...
    <header class="top-container">
        ...
        <nav class="nav-right">
            <ul class="top-list">
                <li><a href="iniciallog.php"><i class="fas fa-arrow-alt-circle-left" style="font-size: 42px; color: #fea303;"></i></i></a></li>
            </ul>
        </nav>
    </header>
    <!--FIM DO HEADER-->
    ...
    <main class="mid-container">
        <section>
            <div class="column3">
                ...
                <div class="acoes">
                    <a href="maquinas-novo.php"><button class="cliente">Nova Máquina</button></a>
                    <a href="maquinas.php"><button class="atualizar">Atualizar</button></a>
                </div>
            </div>
            <hr class="line">
                    ...
                    <tbody>
                        <?php while ($resultado = $consulta->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td> &nbsp;
                                    <a href="maquinas-editar.php?codigo=<?php echo $resultado['avm_codigo']; ?>"><button class="editar">Editar</button> </a>
