...
if (isset($_POST['nome'])) {
	extract($_POST);
	if ($consulta = $conexao->query("insert into tb_funcionarios (fun_nome, fun_cpf, fun_melhoremail, fun_telefoneprincipal, fun_senha, fun_tipo) 
    values ('$nome', '$cpf', '$melhoremail', '$telefoneprincipal', '$senha', '$tipo');")) {
		header("Location: instrutores.php");
	} else {
		echo "Erro no cadastro";
	}
}
$consulta2 = $conexao->query("select * from tb_funcionarios");
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
		...
		<div class="second-container">
			<div class="cadastro">
				...
				<form method="POST" action="?">
					...
					<div class="input-field">
						<input type="varchar(100)" name="melhoremail" placeholder="Digite seu melhor E-mail" required>
						<div class="underline"></div>
					</div>
					<div class="input-field">
						<input type="varchar(15)" name="telefoneprincipal" placeholder="Digite seu melhor Telefone" required>
						<div class="underline"></div>
					</div>
					<div class="input-field">
						<input type="varchar(20)" name="senha" placeholder="Digite uma senha" required>
						<div class="underline"></div>
					</div>
