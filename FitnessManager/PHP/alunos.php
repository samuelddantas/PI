    ...
    <main class="mid-container">
        <section>
            <div class="column3">
                ...
                <div class="acoes">
                    <a href="alunos-novo.php"><button class="cliente">Novo Cliente</button></a>
                    <a href="alunos.php"><button class="atualizar">Atualizar</button></a>
                </div>
            </div>
            <hr class="line">
                ...
                <table class="crud">
                    ...
                    <?php while ($resultado = $consulta->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td>&nbsp;
                                <a href="alunos-editar.php?codigo=<?php echo $resultado['cli_codigo']; ?>"><button class="editar">Editar</button></a>
